...
class App extends Component {
  ...
  render() {
    ...
    const removePost = bindActionCreators(
      PostActionCreators.removePost,
      dispatch
    );
        ...
        <div className="body-container">
          <Switch>
            ...
            <Route
              path="/blog"
              render={routerProps => (
                <Blog data={posts} removePost={removePost} {...routerProps} />
              )}
            />
            <Route
              exact
              path="/createpost"
              render={props => <CreatePost addPost={addPost} {...props} />}
            />
